...
class MealyStateMachineFabric : StateMachineFabric<MealyStateMachine> {
    override fun create(inputStream: InputStream): MealyStateMachine {
    ...
    override fun create(stateMachine: StateMachine<out Any>):MealyStateMachine {
