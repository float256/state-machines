...
class MooreStateMachineFabric: StateMachineFabric<MooreStateMachine> {
    override fun create(inputStream: InputStream): MooreStateMachine {
    ...
    override fun create(stateMachine: StateMachine<out Any>): MooreStateMachine {
